...
@section('content')
    ...
    <section class="auth_section" style="padding-top: 100px">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form  method="POST" action="{{ route('login') }}" class="space-y-4 md:space-y-6">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don’t have an account yet? <a href="{{route('register')}}" class="font-medium text-red-600 hover:underline dark:text-primary-500">Sign up</a>
                        </p>
                    </form>
                </div>
            </div>
